from keyboards.default.markups import menu_markup
...
async def user_mode(message: types.Message):
    ...
    await message.answer('Включен пользовательский режим.', reply_markup=menu_markup())
...
async def admin_mode(message: types.Message):
    ...
    await message.answer('Включен админский режим.', reply_markup=menu_markup())
